...
class WorkOrderSearch extends WorkOrder
{
    ...
    {
        return [
            [['work_order_id', 'customer_id'], 'integer'],
            [['date', 'production_monitoring', 'approved_by', 'created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'production_monitoring', $this->production_monitoring])
