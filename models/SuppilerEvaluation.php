...
/**
 * This is the model class for table "suppiler_evaluation".
 *
 ...
 */
class SuppilerEvaluation extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['vendor_id', 'month', 'total_po', 'purchase_qty', 'value', 'on_time_delevery', 'current_lot_size', 'total_supplied', 'accepted', 'rejected', 'first_performance', 'second_performance', 'third_performance', 'total_marks', 'created_at'], 'required'],
            [['vendor_id', 'total_po', 'purchase_qty', 'value', 'on_time_delevery', 'current_lot_size', 'total_supplied', 'accepted', 'rejected'], 'integer'],
            [['created_at'], 'safe'],
